...
<body>
    ...
    <header>
        <div class="container header-section flex">
            <div class="header-left">
                ...
                <a href="downloads.php" class="primary-button get-started-btn">Get Started</a>
            </div>
    ...
    <section class="big-feature-section">
        <div class="container flex big-feature-container">
            ...
            <div class="feature-desc flex">
                ...
                <a href="Login.php" class="secondary-button">Sign up <i class="fa-solid fa-right-long"></i></a>
            </div>
        </div>
    </section>
    ...
    <section class="big-feature-section">
        <div class="container flex big-feature-container" id="second-big-feature">
            ...
            <div class="feature-desc flex">
                ...
                <a href="downloads.php" class="secondary-button">Create CV<i class="fa-solid fa-right-long"></i></a>
            </div>
        </div>
    </section><br><br>
    ...
    <section class="cta-section">
        <div class="container flex cta-section-container">
            ...
            <a href="downloads.php" class="primary-button">Create CV Now</a>
        </div>
    </section>
